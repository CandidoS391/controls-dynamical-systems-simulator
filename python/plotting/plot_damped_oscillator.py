...
with open("output/damped_oscillator_euler.csv", mode='r') as euler_file:
  next(euler_file)
...
with open("output/damped_oscillator_rk4.csv", mode='r') as rk4_file:
  next(rk4_file)
...
plt.title("Damped Oscillator Phase Portrait")
...
plt.figure(1)
plt.savefig("output/damped_position_vs_time.png")

plt.figure(2)
plt.savefig("output/damped_phase_portrait.png")
